-- ============================================================================
-- Public menu read functions (Epic 5, tickets #16-#18) and QR permission (#19)
-- ============================================================================

insert into permissions (key, description)
values ('menu.read', 'Read tenant menu/admin QR targets')
on conflict (key) do update set description = excluded.description;

insert into role_permissions (role_id, permission_key)
select r.id, 'menu.read'
  from roles r
 where r.key in ('owner', 'manager', 'service', 'kitchen', 'marketing')
